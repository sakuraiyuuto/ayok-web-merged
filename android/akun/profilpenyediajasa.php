		...
		<div class="box9">
			<div class="part">
				<?php
					...
					$perintah7 = "SELECT * FROM ratingjasa where id_jasa='$row[1]'";
			...
			if($row7=mysqli_fetch_array($hasil7))
			{
				...
				if($row[10]>'0')
				{
					echo "<div class=\"ratingverified\">";echo "Rating : ".$row7[1]."/".$ratingfinalstar;echo"</div>";
				}
				else  
				{
					echo "<div class=\"ratingnotverified\">";echo "Rating : ".$row7[1]."/".$ratingfinalstar;echo"</div>";
				}
			}
