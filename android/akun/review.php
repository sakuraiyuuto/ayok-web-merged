<?php
	...
	else 
	{
		...
		echo "<form name=\"form2\" method=\"post\" action=\"../sistem/reviewproses.php\">";
		echo "<table border=0>";
		...
		echo "<td><input class=\"reviewinput\" type=\"text\" required name=\"review\" size=\"60\"  placeholder=\"Review\"></td></tr></table>";
		echo "</div>";
			echo "<input type=\"submit\" class=\"submitreview\" value=\"Kirim Ulasan\">";
		echo "</form>";
	}
?>