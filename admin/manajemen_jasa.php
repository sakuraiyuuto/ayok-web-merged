		...
		<div class="isi-content">	
			<?php
				...
				if(isset($_POST['search'])) {
					$id = $_POST['keyword'];
					$sql = mysqli_query($link,"SELECT a.id_kategorijasa, a.id_jasa, b.id_akun, c.nama_kategori, a.nama_jasa, a.keterangan, a.alamat, a.hargamin, a.hargamax, a.telepon, a.verifikasi_status, d.nama_foto from jasa a 
									INNER JOIN user b ON a.id_akun = b.id_akun INNER JOIN kategori c ON a.id_kategorijasa = c.id_kategori2 INNER JOIN foto d ON a.id_jasa = d.id_jasa WHERE a.id_jasa LIKE '%$id%'");
				}
